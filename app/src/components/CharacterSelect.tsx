...
function CharacterSelect() {
  ...
  return (
    <section id="character-select" className="m-auto w-11/12 md:w-10/12">
      ...
      <div className="characters grid place-items-center grid-cols-6 md:grid-cols-10 gap-3 m-5">
        <button className="character donggeon flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Donggeon.imageUrl} alt=""/>
          <img className="name" src={characters.Donggeon.nameUrl} alt=""/>
        </button>
        <button className="character chan flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Chan.imageUrl} alt=""/>
          <img className="name" src={characters.Chan.nameUrl} alt=""/>
        </button>
        <button className="character jisu flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Jisu.imageUrl} alt=""/>
          <img className="name" src={characters.Jisu.nameUrl} alt=""/>
        </button>
        <button className="character jaeyun flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Jaeyun.imageUrl} alt=""/>
          <img className="name" src={characters.Jaeyun.nameUrl} alt=""/>
        </button>
        <button className="character j-you flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters["J.You"].imageUrl} alt=""/>
          <img className="name" src={characters["J.You"].nameUrl} alt=""/>
        </button>
        <button className="character kyungho flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Kyungho.imageUrl} alt=""/>
          <img className="name" src={characters.Kyungho.nameUrl} alt=""/>
        </button>
        <button className="character daigo flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Daigo.imageUrl} alt=""/>
          <img className="name" src={characters.Daigo.nameUrl} alt=""/> 
        </button>
        <button className="character renta flex flex-col items-center m-3" onClick={onCharacterClick}>
          <img className="avatar" src={characters.Renta.imageUrl} alt=""/>
          <img className="name" src={characters.Renta.nameUrl} alt=""/>
        </button>
        <button className="character yeojeong flex flex-col items-center m-3" onClick={onCharacterClick}>
      ...
      <div className="bottom-section flex flex-col items-center">
        ...
        <button className="character-set btn rounded-lg px-4 py-2">Confirm</button>
      </div>
    </section>
  )
}
